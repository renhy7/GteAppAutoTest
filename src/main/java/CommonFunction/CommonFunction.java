...
//		driver.findElementById("com.gantang.gantang:id/iv_head").click();
	...
	public static String getAndroidDeviceNumber(){
		...
		try {
			...
			adbDeviceNumber = sb.toString().split(" ")[4].split("	")[0].toString();
 ...
 */
	...
	public static void StartAppiumService(){
		...
		String cmd = "cmd /c start appium -a 127.0.0.1 -p 4723 --platform-name " + platform 
				+ "  --platform-version 6.1 --device-name "+ getAndroidDeviceNumber() 
				+ " --app-activity com.gantang.gantang.activitys.WelComeActivity --app-pkg " + apppkg 
	...
	public static AndroidDriver getAndroidDriver(){
		...
		capabilities.setCapability("appWaitActivity", "com.gantang.gantang.activitys.WelComeActivity"); //add
		
		capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, AutomationName.ANDROID_UIAUTOMATOR2); //add
	 ...
	 * @return
	 */
	public static boolean checkElementDisplays(AndroidDriver driver, WebElement element, int timeoutInSeconds) {
		try {
	...
	public static boolean checkElementExists(AndroidDriver driver, WebElement element, int timeoutInSeconds) {
		try {
			driver.manage().timeouts().implicitlyWait(timeoutInSeconds, TimeUnit.SECONDS);
			return true;
		} catch (NoSuchElementException e) {
    ...
    public static AndroidDriver getAndroidWeiXinDriver(){
		...
		caps.setCapability(MobileCapabilityType.DEVICE_NAME, getAndroidDeviceNumber());// “devicesName”
   ...
   public static String getPhotoAndMessageValidate(String str, int index){
	...
	public static void Login(AndroidDriver driver, Pages pages, String mobile, String defaultPassword){
		...
		if(checkElementDisplays(driver, pages.LeftNavigation_PhoneNumber, 5)){
			...
			pages.Login_InputValidateCode.sendKeys(getPhotoAndMessageValidate("cmn:verify:"+mobile+":imgcode", 15));
