...
public class NAHomeStationQuery extends SupperTestClass {
	...
	String insertIntoRoutesPlanssql = "INSERT INTO `service_number_plans` "
			...
			+ "'21:30:00','16.8','','1','0','" + CommonFunction.getNowTime() + "','"
			+ CommonFunction.getNowTime() + "','22:15:00'," + "'1','0','0.01','"
			+ query + "','" + CommonFunction.getNowDateFormatyyyyMMdd()
			+ " 21:30:00','" + CommonFunction.getNowDateFormatyyyyMMdd()
			+ " 22:15:00','1','1')";
	// 删除已经存在的计划
	...
	public void NAHomeStationQuery() {
		try {
			...
			if(CommonFunction.checkElementDisplays(driver, pages.Home_StartStationName, 10))
			pages.Home_StartStationName.click();

			pages.Home_EndStationDelete.click();
			pages.Home_EndStationInput.sendKeys(endStationName);
			if(CommonFunction.checkElementDisplays(driver, pages.Home_EndStationName, 10))
			...
			if(CommonFunction.checkElementDisplays(driver, pages.Home_StartStationNameNo, 10))
			pages.Home_StartStationNameNo.click();
			
			pages.Home_EndStationDelete.click();
			pages.Home_EndStationInput.sendKeys(endStationName_No);
			if(CommonFunction.checkElementDisplays(driver, pages.Home_EndStationNameNo, 10))
			...
			if (CommonFunction.checkElementDisplays(driver,
				...
				if (CommonFunction.checkElementDisplays(driver,
						...
						&& CommonFunction.checkElementDisplays(driver,
